...
// Connect to MongoDB
mongoose
  .connect('mongodb+srv://fatima:lH4C9Q8nlq86ToTp@cluster0.mheaj.mongodb.net/Ecommerce?retryWrites=true&w=majority&appName=Cluster0')
  .then(() => {
...
app.get('/api/products', (req, res) => {
  ...
  Productmodel.find().then((data) => {
    ...
    res.send('sorry cant retrieve data');
  });
});
